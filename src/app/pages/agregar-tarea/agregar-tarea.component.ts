...
export class AgregarTareaComponent {
  ...
  private setDatosTareaEnFormGroup() {
    ...
    this.datosTarea.controls.descripcion.setValue(this.tareaAEditar?.descripcion || "");
    this.datosTarea.controls.fechaTermino.setValue(this.tareaAEditar?.fechaTermino);
    this.datosTarea.controls.nombreLista.setValue(this.tareaAEditar?.nombreLista || "");
  }
